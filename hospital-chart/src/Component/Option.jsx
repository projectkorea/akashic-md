    ...
    return isCenter
        ? {
              ...
              dataZoom: {
                  ...
                  zoomLock: true,
                  startValue:
                      ctData.reExamination.length > 23
                          ? ctData.time[ctData.reExamination.length - 23]
                          : ctData.time[0],
                  endValue:
                      ctData.reExamination.length > 23
                          ? ctData.time[ctData.reExamination.length - 1]
                          : ctData.time[22],
              },
              series: [
                  {
    ...
    return isCenter
        ? {
              ...
              dataZoom: {
                  ...
                  zoomLock: true,
                  startValue:
                      bar2Data.now.length > 23
                          ? bar2Data.time[bar2Data.now.length - 23]
                          : bar2Data.time[0],
                  endValue:
                      bar2Data.now.length > 23
                          ? bar2Data.time[bar2Data.now.length - 1]
                          : bar2Data.time[22],
              },
              series: [
                  {
        ...
        ? {
              tooltip: {
                  ...
                  formatter(params) {
                      ...
                      return ` 
                    <div style = "width: 210px; height: 260px; margin:-10px; padding: 20px; color:${
                        params.color
                    };">
                      <div style ="margin: -10px; padding: 23px; width: 170px; height: 240px; background-color:${
                          params.color
                      }; color:white;>
              ...
              dataZoom: {
                  ...
                  zoomLock: true,
                  startValue:
                      heatData.comingPerson.length > 92
                          ? heatData.time[heatData.comingPerson.length / 4 - 23]
                          : heatData.time[0], // (heatData.co.length  / 4) -23
                  endValue:
                      heatData.comingPerson.length > 92
                          ? heatData.time[heatData.comingPerson.length / 4 - 1]
                          : heatData.time[22],
              },
              series: [
                  {
    ...
    return isCenter
      ...
      `;
              ...
              dataZoom: {
                  ...
                  zoomLock: true,
                  startValue:
                      barGraphData.operation.length > 13
                          ? barGraphData.time[barGraphData.operation.length - 13]
                          : barGraphData.time[0],
                  endValue:
                      barGraphData.operation.length > 13
                          ? barGraphData.time[barGraphData.operation.length - 1]
                          : barGraphData.time[12],
              },
              series: [
                  {
                      name: "예상 검사/ 수술 수",
    ...
    return isCenter
        ? {
              ...
              dataZoom: {
                  ...
                  zoomLock: true,
                  startValue:
                      scatterData.mainBuilding.length > 41
                          ? ArrayName[scatterData.mainBuilding.length - 41]
                          : startHour,
                  endValue:
                      scatterData.mainBuilding.length > 41
                          ? ArrayName[scatterData.mainBuilding.length - 1]
                          : 1656054900467,
              },
    ...
    return isCenter
        ? {
              ...
              dataZoom: {
                  ...
                  zoomLock: true,
                  startValue:
                      comingData.coming.length > 12
                          ? comingData.time[comingData.coming.length - 12]
                          : comingData.time[0],
                  endValue:
                      comingData.coming.length > 12
                          ? comingData.time[comingData.coming.length - 1]
                          : comingData.time[11],
              },
              grid: {
                  left: "8%",
